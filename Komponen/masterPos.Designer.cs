...
namespace KASIR.komponen
{
    partial class masterPos
    {
        ...
        private void InitializeComponent()
        {
            ...
            button7.ForeColor = Color.FromArgb(31, 30, 68);
            button7.IconChar = IconChar.Receipt;
            button7.IconColor = Color.FromArgb(31, 30, 68);
            button7.IconFont = IconFont.Auto;
            button7.IconSize = 25;
            button7.ImageAlign = ContentAlignment.MiddleRight;
            button7.Location = new Point(4, 14);
            button7.Name = "button7";
            button7.Size = new Size(154, 35);
            button7.TabIndex = 23;
            button7.Text = "Split Bill";
            button7.TextImageRelation = TextImageRelation.ImageBeforeText;
            button7.UseVisualStyleBackColor = true;
            button7.Click += iconButton4_Click;
            // 
            // iconButton1
            // 
            ...
            iconButton2.ForeColor = Color.FromArgb(31, 30, 68);
            iconButton2.IconChar = IconChar.FileDownload;
            iconButton2.IconColor = Color.FromArgb(31, 30, 68);
            iconButton2.IconFont = IconFont.Auto;
            iconButton2.IconSize = 25;
            iconButton2.ImageAlign = ContentAlignment.MiddleRight;
            iconButton2.Location = new Point(163, 14);
            iconButton2.Name = "iconButton2";
            iconButton2.Size = new Size(160, 35);
            iconButton2.TabIndex = 20;
            iconButton2.Text = "Simpan Bill";
            iconButton2.TextImageRelation = TextImageRelation.ImageBeforeText;
            iconButton2.UseVisualStyleBackColor = true;
            iconButton2.Click += button2_Click;
            // 
            // panel4
            // 
