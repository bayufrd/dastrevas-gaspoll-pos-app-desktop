        ...
        public async void LoadData()
        {
            try
            {
                ...
                foreach (Menu menu in menuList)
                {
                    ...
                    DateTime updatedAt;
                    // Format yang benar sesuai dengan tampilan yang diinginkan
                    ...
                    {
                        // Jika parsing gagal, tampilkan log error dan format tanggal aslinya
                        //Console.WriteLine("Failed to parse date: " + menu.invoice_due_date);
                        dataTable.Rows.Add(menu.id, numberQueue + ". " + menu.receipt_number, menu.outlet_id, menu.cart_id, menu.customer_name, menu.customer_seat ?? "0", string.Format("Rp. {0:n0},-", total), menu.payment_type, menu.invoice_due_date.ToString(), numberQueue); // Menambahkan pesan kesalahan
                    }
                }
